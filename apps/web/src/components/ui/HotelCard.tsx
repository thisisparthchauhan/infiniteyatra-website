...
const HotelCard: React.FC<HotelProps> = ({ id, slug, name, city, rating, price, imageUrl }) => {
    return (
        <motion.div
            whileHover={{ y: -5 }}
        ...
        >
            ...
            <div className="p-5">
                ...
                <div className="flex items-center justify-between mt-4">
                    ...
                    <button className="bg-zinc-900 dark:bg-white text-white dark:text-black px-5 py-2.5 rounded-xl text-sm font-semibold hover:bg-zinc-800 dark:hover:bg-zinc-200 transition-colors">
                        View Details
                    </button>
                </div>
            </div>
